          ...
          <div class="p-4">
            ...
            <div class="text-center mt-4 space-y-2">
              ...
              <div class="flex justify-evenly">
                <span
                  @click="confirmDelete()"
                  class="border border-green-600 rounded-md py-1 px-2 text-sm bg-green-600 text-white hover:bg-green-800 transition-all duration-300 cursor-pointer"
                  >Yes <i class="fa-solid fa-check"></i
                ></span>
                <span
                  @click="cancelDelete()"
                  class="border border-red-600 rounded-md py-1 px-2 text-sm bg-red-600 text-white hover:bg-red-800 transition-all duration-300 cursor-pointer"
